<section class="mb-12">
    <h1 class="text-3xl font-bold text-gray-800">Tentang Kami 🎯</h1>
    <p class="mt-2 text-gray-600">Mengenal lebih dekat dengan mindsea dan visi misi kami</p>
</section>
...
<section class="mb-12">
    <div class="bg-[#fceede]/30 rounded-xl p-8 border-2 border-[#f58a66]/20">
...
<section class="mb-12">
    <div class="bg-white p-8 rounded-xl border-2 border-[#f58a66]/20 shadow-md">
