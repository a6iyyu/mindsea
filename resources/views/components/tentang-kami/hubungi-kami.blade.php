<section class="mb-12 bg-white p-6 rounded-xl border-4 border-[#f58a66]/20 shadow-md lg:p-8">
  ...
  <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
    <a href="mailto:info@mindsea.com"
      ...
      <h5 class="text-gray-700">info@mindsea.com</h5>
    </a>
    <a href="tel:+6281234567890"
      ...
      <h5 class="text-gray-700">+62 812 3456 7890</h5>
    </a>
    <a href="#"
      ...
      <h5 class="text-gray-700">Malang, Indonesia</h5>
    </a>
  </div>
</section>