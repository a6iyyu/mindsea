 <section class="mb-12">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        ...
        <div class="p-6 bg-white rounded-xl border-2 border-[#f58a66]/20 hover:shadow-md transition-all">
    ...
    <section class="bg-[#fceede]/30 rounded-xl p-8 border-2 border-[#f58a66]/20">
