<section class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    @foreach($materi as $item)
        <div class="rounded-xl border-4 border-{{ $item['warna'] }}-200 bg-white p-8 shadow-lg transition-all hover:shadow-xl focus-within:ring-4 focus-within:ring-{{ $item['warna'] }}-200">
