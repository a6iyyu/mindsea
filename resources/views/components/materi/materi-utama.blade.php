...
<main class="ml-16 min-h-screen px-6 pt-28 pb-16 bg-white lg:ml-68 lg:py-28 lg:pr-10 lg:pl-60">
  <figure class="border-4 p-8 rounded-2xl transition-shadow shadow-lg bg-orange-50 border-orange-200 lg:hover:shadow-xl">
    ...
    <h4 class="prose max-w-none bg-transparent rounded-xl text-base leading-relaxed text-gray-700 lg:p-6 lg:text-xl lg:bg-white">
      {!! $mainContent->content !!}
    </h4>
  </figure>
  <nav class="mt-8 flex flex-col justify-between items-center lg:flex-row">
    ...
    <a
      href="{{ route('materi.show.exercise', $materi['id']) }}"
