<section aria-labelledby="latihan-soal-heading">
    <h2 id="latihan-soal-heading" class="sr-only">Daftar Latihan Soal</h2>
    ...
    <nav aria-label="Filter mata pelajaran">
    ...
    <main>
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
            ...
            @foreach($mataPelajaran as $mp)
                <article class="rounded-xl border-4 border-{{ $mp['warna'] }}-200 bg-white p-8 shadow-lg transition-all hover:shadow-xl">
