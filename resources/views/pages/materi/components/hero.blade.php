<section class="mb-12">
    ...
    <div class="relative mt-8">
        <form role="search">
            ...
            <input type="search" id="search-materi" name="search-materi" placeholder="Cari materi yang ingin kamu pelajari..." class="w-full px-6 py-4 text-lg bg-[#fceede]/30 border-3 border-[#f58a66]/20 rounded-xl shadow-sm 
            ...
            <button type="submit" class="absolute right-3 top-8 -translate-y-1/2 p-2 hover:bg-[#f58a66]/10 rounded-lg transition-colors"
        ...
        <nav class="mt-4">
            <ul class="flex flex-wrap gap-4">
                <li>
                    <button class="px-4 py-2 text-xl bg-[#fceede] text-[#f58a66] rounded-lg hover:bg-[#f58a66]/10 transition-colors">
