    ...
    <article class="bg-white p-8 rounded-xl border-4 border-[#f58a66]/20 shadow-md mb-8">
        <header class="flex items-center gap-4 mb-8">
            <span class="bg-[#fceede] p-4 rounded-xl">
                <i class="fa-solid fa-user text-2xl text-[#f58a66]"></i>
            </span>
        ...
        <form action="{{ route('profile.password') }}" method="post" class="space-y-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="password" id="current_password" name="current_password" class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-[#f58a66] focus:ring-2 focus:ring-[#f58a66]/20 transition-colors">
                </div>

                <div>
                    <label for="new_password" class="block text-lg font-medium text-gray-700 mb-2">Password Baru</label>
                    <input type="password" id="new_password" name="new_password" class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-[#f58a66] focus:ring-2 focus:ring-[#f58a66]/20 transition-colors">
                </div>

                <div>
                    <label for="new_password_confirmation" class="block text-lg font-medium text-gray-700 mb-2">Konfirmasi Password Baru</label>
                    <input type="password" id="new_password_confirmation" name="new_password_confirmation" class="w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:border-[#f58a66] focus:ring-2 focus:ring-[#f58a66]/20 transition-colors">
                </div>
            </div>
