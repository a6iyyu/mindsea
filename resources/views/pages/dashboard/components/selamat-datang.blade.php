<main class="mb-12 text-center">
    ...
    <article class="mt-4 flex items-center justify-center gap-3">
        <i class="fas fa-lightbulb text-2xl text-yellow-500" aria-hidden="true"></i>
