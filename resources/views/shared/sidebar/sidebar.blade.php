                ...
                <li class="flex items-center justify-between mb-4">
                    <a href="{{ $item['route'] }}"
                        ...
                        <span class="group hidden text-lg font-semibold transition-all duration-300 ease-in-out md:block">
                            <span class="lg:bg-gradient-to-r lg:from-{{ strtolower(str_replace('text-', '', $item['warna'])) }} lg:to-{{ strtolower(str_replace('text-', '', $item['warna'])) }} lg:bg-[length:0%_0.125rem] lg:bg-left-bottom lg:bg-no-repeat lg:transition-all lg:duration-500 lg:ease-out lg:group-hover:bg-[length:100%_0.125rem]">
                                {{ $item['label'] }}
                            </span>
                        </span>
                    </a>
